...
class HolidaysTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals(12, Zman::dayOfYomKippur('5777')->day);
        $this->assertEquals(10, Zman::dayOfYomKippur('5777')->month);
        $this->assertEquals(2016, Zman::dayOfYomKippur('5777')->year);
    }
